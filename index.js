...
var account1_mnemonic = 'security volume farm inspire super profit tomorrow crawl garden oval frog hover actual opinion obtain critic giraffe frame lounge inquiry bicycle enjoy metal about state'; //"canal enact luggage spring similar zoo couple stomach shoe laptop middle wonder eager monitor weather number heavy skirt siren purity spell maze warfare ability ten";
...
(async () => {
    ...
    let totalIssuance = 16000000;
    // Used to display asset units to user    
    let unitName = "JAVACAFE";
    // Friendly name of the asset    
    let assetName = "JTC";
    // Optional string pointing to a URL relating to the asset
    let assetURL = "http://www.javatimescaffe.com";
